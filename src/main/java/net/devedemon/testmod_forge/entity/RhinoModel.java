package net.devedemon.testmod_forge.entity;

import com.mojang.blaze3d.vertex.PoseStack;
import com.mojang.blaze3d.vertex.VertexConsumer;
import net.devedemon.testmod_forge.entity.animations.RhinoModelAnimation;
import net.devedemon.testmod_forge.entity.custom.RhinoEntity;
...
public class RhinoModel<T extends Entity> extends HierarchicalModel<T> {
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.animateWalk(RhinoModelAnimation.RHINO_WALK, limbSwing, limbSwingAmount, 2f, 2.5f);
		this.animate(((RhinoEntity) entity).idleAnimationState, RhinoModelAnimation.RHINO_IDLE, ageInTicks, 1f);
		this.animate(((RhinoEntity) entity).attackAnimationState, RhinoModelAnimation.RHINO_ATTACK, ageInTicks, 1f);
	}

	private void applyHeadRotation(float pNetHeadYaw, float pHeadPitch, float pAgeInTicks) {
		pNetHeadYaw = Mth.clamp(pNetHeadYaw, -30f, 30f);
		pHeadPitch = Mth.clamp(pHeadPitch, -25f, 25f);
